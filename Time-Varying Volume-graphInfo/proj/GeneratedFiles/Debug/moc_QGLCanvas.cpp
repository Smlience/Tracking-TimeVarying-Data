...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QGLCanvas_t, stringdata) + ofs \
...
const QMetaObject QGLCanvas::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_QGLCanvas.data,
      qt_meta_data_QGLCanvas,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGLCanvas.stringdata))
        return static_cast<void*>(const_cast< QGLCanvas*>(this));
    if (!strcmp(_clname, "Observable<IUpdatable>"))
        return static_cast< Observable<IUpdatable>*>(const_cast< QGLCanvas*>(this));
